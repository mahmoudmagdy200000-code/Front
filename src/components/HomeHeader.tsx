            ...
            <div className="container mx-auto px-6 py-3 flex items-center justify-between gap-6 relative">
                ...
                <div className={`flex items-center gap-4 z-20 ${!isDesktop ? 'w-full justify-between' : ''}`}>
                    <div className="flex items-center gap-2">
                        ...
                        {/* Mobile Language Switcher - Compact Globe Style */}
                        {!isDesktop && (
                            <div className="flex items-center border-l border-gray-200 ml-1 pl-1">
                                <LanguageSwitcher className="px-2 py-1.5 hover:bg-gray-50 border-0" labelClassName="hidden xs:inline" />
                            </div>
                        )}
                    </div>
                                ...
                                {(role === 'Admin' || role === 'SuperAdmin') && (
                                    ...
                                    >
                                        ...
                                        <span className="hidden sm:inline">
                                            {role === 'SuperAdmin' ? (isRTL ? 'إدارة عليا' : 'Super Admin') : (isRTL ? 'الإدارة' : 'Admin')}
                                        </span>
                                    </Link>
                                )}
