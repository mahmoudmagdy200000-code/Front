                                        ...
                                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl p-6 min-w-[280px] space-y-6">
                                                ...
                                                <div className="pt-4 border-t border-gray-200 space-y-2">
                                                    ...
                                                    {booking.Status === 'Confirmed' && (
                                                        <>
                                                            <div className="flex justify-between items-center text-sm bg-green-50 -mx-2 px-2 py-2 rounded-lg">
                                                                <span className="text-green-700 font-bold flex items-center gap-1.5">
                                                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                                                    </svg>
                                                                    {isRTL ? 'العربون المدفوع' : 'Paid Deposit'}
                                                                </span>
                                                                <span className="font-black text-green-700">
                                                                    {booking.DepositAmount || 0} {isRTL ? 'ج.م' : 'EGP'}
                                                                </span>
                                                            </div>
                                                        </>
                                                    )}
